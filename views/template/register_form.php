      ...
      <div class="modal-body">
        ...
        <form action="" method="POST">
          <div class="form-group">
            ...
            <input required type="email" class="form-control" name="mail" id="recipient-mail" placeholder="example@mail.com">
          ...
          <div class="form-group">
             ...
             <input required type="number" max="95999" size="5" class="form-control" name="cp" id="recipient-prenom">
          </div>
          <div class="form-group">
